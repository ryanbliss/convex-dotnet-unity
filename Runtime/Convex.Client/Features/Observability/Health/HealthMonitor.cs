...
public HealthMonitor(ILogger? logger = null, bool enableDebugLogging = false)
{
    this._logger = logger;
    ...
    public IReadOnlyList<Exception> GetRecentErrors() => global::System.Linq.Enumerable.ToArray(_recentErrors);
...
internal sealed class HealthCheckBuilder
{
    ...
    {
        _recentErrors ??= new global::System.Collections.Generic.List<global::System.Exception>();
    ...
    {
        _additionalData ??= new global::System.Collections.Generic.Dictionary<string, object>();
