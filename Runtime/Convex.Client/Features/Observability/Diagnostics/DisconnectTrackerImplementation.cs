...
/// </summary>
internal sealed class DisconnectTrackerImplementation : IDisconnectTracker
{
private TimeSpan? longDisconnectThreshold;
public DisconnectTrackerImplementation(TimeSpan? longDisconnectThreshold = null)
{
    this._longDisconnectThreshold = longDisconnectThreshold ?? TimeSpan.FromSeconds(30);
    this.longDisconnectThreshold = longDisconnectThreshold;
}    private DateTimeOffset? _disconnectedAt;
    private readonly TimeSpan _longDisconnectThreshold ;
    private readonly List<DisconnectEvent> _disconnectHistory = new global::System.Collections.Generic.List<global::Convex.Client.Features.Observability.Diagnostics.DisconnectEvent>();
    ...
    public IReadOnlyList<DisconnectEvent> DisconnectHistory
    {
        get
        {
            lock (_lock)
            {
                return global::System.Linq.Enumerable.ToArray(_disconnectHistory);
            }
        }
    }
