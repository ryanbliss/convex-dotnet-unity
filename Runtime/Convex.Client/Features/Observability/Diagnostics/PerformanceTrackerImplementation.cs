...
internal sealed class PerformanceTrackerImplementation : IPerformanceTracker
{
    ...
    private readonly List<PerformanceEntry> _entries = new global::System.Collections.Generic.List<global::Convex.Client.Features.Observability.Diagnostics.PerformanceEntry>();
...
#pragma warning restore IDE0330 // Use 'System.Threading.Lock'
    ...
    public IReadOnlyList<PerformanceEntry> Entries
    {
        get
        {
            lock (_entriesLock)
            {
                return global::System.Linq.Enumerable.ToArray(_entries);
            }
        }
    }
    ...
    public IReadOnlyList<PerformanceEntry> GetEntriesByName(string name)
    {
        lock (_entriesLock)
        {
            return global::System.Linq.Enumerable.ToArray(_entries.Where(e => e.Name == name));
        }
    }
    ...
    public IReadOnlyList<PerformanceEntry> GetEntriesByType(string type)
    {
        lock (_entriesLock)
        {
            return global::System.Linq.Enumerable.ToArray(_entries.Where(e => e.EntryType == type));
        }
    }
