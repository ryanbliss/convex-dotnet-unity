...
/// </param>
public sealed class ObservableConvexList<T>: IList<T>, INotifyCollectionChanged, INotifyPropertyChanged, IDisposable
{
private SynchronizationContext? synchronizationContext;
public ObservableConvexList(SynchronizationContext? synchronizationContext = null)
{
    this._synchronizationContext = synchronizationContext ?? SynchronizationContext.Current;
    this.synchronizationContext = synchronizationContext;
}    private readonly object _lock = new();
    private readonly List<T> _items = new global::System.Collections.Generic.List<T>();
    ...
    private sealed class SubscriptionBinding : IDisposable
    {
private ObservableConvexList<T> list;
public SubscriptionBinding(ObservableConvexList<T> list)
{
    this._list = list;
    this.list = list;
}        private ObservableConvexList<T>? _list ;
