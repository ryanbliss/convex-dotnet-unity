...
#pragma warning restore CVX001, CVX002
    ...
    private void EmitMergedUpdate(IEnumerable<T>? subscriptionItems = null)
    {
        ...
        var itemsToMerge = subscriptionItems ?? global::System.Array.Empty<T>();
...
public class PaginatedSubscriptionUpdate<T>
{
    ...
    /// </summary>
    public IReadOnlyList<T> Items { get; set; } = global::System.Array.Empty<T>();

    /// <summary>
    /// The current page boundaries.
    /// </summary>
    public IReadOnlyList<int> PageBoundaries { get; set; } = global::System.Array.Empty<int>();
