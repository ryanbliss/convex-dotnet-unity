...
/// </summary>
internal sealed class Paginator<T>: IPaginator<T>
{
...
public Paginator(IHttpClientProvider httpProvider, IConvexSerializer serializer, string functionName, int pageSize, object? args, ILogger? logger = null, bool enableDebugLogging = false)
{
...
public PropertyMetadata(PropertyInfo property, string jsonName)
{
    this.Property = property;
    this.JsonName = jsonName;
    this.property = property;
    this.jsonName = jsonName;
}        public PropertyInfo Property { get; }         public string JsonName { get; }     }
    ...
    private readonly List<T> _loadedItems = new global::System.Collections.Generic.List<T>();
    private readonly List<int> _pageBoundaries = new global::System.Collections.Generic.List<int>();
    ...
    public IReadOnlyList<T> LoadedItems
    {
        get
        {
            lock (_paginationLock)
            {
                return global::System.Linq.Enumerable.ToArray(_loadedItems);
            }
        }
    }
    ...
    public IReadOnlyList<int> PageBoundaries
    {
        get
        {
            lock (_paginationLock)
            {
                return global::System.Linq.Enumerable.ToArray(_pageBoundaries);
            }
        }
    }
    ...
    public async Task<IReadOnlyList<T>> LoadNextAsync(CancellationToken cancellationToken = default)
    {
        ...
        if (_args != null)
        {
            ...
            var properties = PropertyCache.GetOrAdd(argsType, static type =>
            {
                ...
                return global::System.Linq.Enumerable.ToArray(props.Select(static prop =>
                {
        ...
        Func<T, IComparable>? getSortKey = null)
    {
        ...
        lock (_paginationLock)
        {
            paginatedItems = new global::System.Collections.Generic.List<T>(_loadedItems);
            originalBoundaries = new global::System.Collections.Generic.List<int>(_pageBoundaries);
        }
        ...
        if (getSortKey != null)
        {
            mergedItems = new global::System.Collections.Generic.List<T>(itemDict.Values.OrderBy(getSortKey));
        }
        else
        {
            ...
            mergedItems = new global::System.Collections.Generic.List<T>();
            foreach (var item in paginatedItems)
            {
                var id = getId(item);
    ...
    public async IAsyncEnumerable<T> AsAsyncEnumerable([EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        ...
        lock (_paginationLock)
        {
            loadedSnapshot = new global::System.Collections.Generic.List<T>(_loadedItems);
        }
