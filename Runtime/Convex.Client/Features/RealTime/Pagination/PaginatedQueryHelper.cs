...
public class PaginatedQueryHelper<T> : IDisposable
{
    ...
    private List<T> _currentItems = new global::System.Collections.Generic.List<T>();
    private List<int> _currentBoundaries = new global::System.Collections.Generic.List<int>();
    ...
    public IReadOnlyList<T> CurrentItems
    {
        get
        {
            lock (_lock)
            {
                return global::System.Linq.Enumerable.ToArray(_currentItems);
            }
        }
    }
    ...
    public IReadOnlyList<int> PageBoundaries
    {
        get
        {
            lock (_lock)
            {
                return global::System.Linq.Enumerable.ToArray(_currentBoundaries);
            }
        }
    }
...
#pragma warning restore CVX001, CVX002
    ...
    private void OnSubscriptionError(Exception error)
    {
        ...
        lock (_lock)
        {
            ItemsUpdated?.Invoke(global::System.Linq.Enumerable.ToArray(_currentItems), global::System.Linq.Enumerable.ToArray(_currentBoundaries));
        }
    }
    ...
    private void MergeSubscriptionItemsInternal(IEnumerable<T> subscriptionItems)
    {
        ...
        lock (_lock)
        {
            _currentItems = new global::System.Collections.Generic.List<T>(merged.MergedItems);
            _currentBoundaries = new global::System.Collections.Generic.List<int>(merged.AdjustedBoundaries);
        }
    ...
    private void UpdateCurrentItems()
    {
        ...
        lock (_lock)
        {
            _currentItems = new global::System.Collections.Generic.List<T>(paginator.LoadedItems);
            _currentBoundaries = new global::System.Collections.Generic.List<int>(paginator.PageBoundaries);
        }
