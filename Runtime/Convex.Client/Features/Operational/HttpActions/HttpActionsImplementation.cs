...
/// </summary>
internal class HttpActionsImplementation{
private IHttpClientProvider httpProvider;
private IConvexSerializer serializer;
private ILogger? logger;
private bool enableDebugLogging;
public HttpActionsImplementation(IHttpClientProvider httpProvider, IConvexSerializer serializer, ILogger? logger = null, bool enableDebugLogging = false)
{
    ...
    {
        var customHeaders = headers ?? new global::System.Collections.Generic.Dictionary<string, string>();
