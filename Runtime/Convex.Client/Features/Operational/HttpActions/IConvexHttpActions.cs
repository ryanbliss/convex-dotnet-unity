...
public class ConvexHttpActionResponse<T>
{
    ...
    /// </summary>
    public Dictionary<string, string> Headers { get; init; } = new global::System.Collections.Generic.Dictionary<string, string>();
...
{
private HttpActionErrorType errorType;
private string message;
private string? actionPath;
private HttpStatusCode? statusCode;
private Exception? innerException;
public ConvexHttpActionException(HttpActionErrorType errorType, string message, string? actionPath = null, HttpStatusCode? statusCode = null, Exception? innerException = null) : base(message, innerException)
{
