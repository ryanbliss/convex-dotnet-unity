...
public sealed class OptimisticCollection<T> : IReadOnlyList<T>, IDisposable
{
    public OptimisticCollection(IEnumerable<T> items)
    {
        _items = new List<T>(items ?? global::System.Array.Empty<T>());
    }
    ...
    /// </summary>
    public OptimisticCollection() : this(global::System.Array.Empty<T>())
    {
    }
    ...
    public void CreateSnapshot()
    {
        ...
        {
            ThrowIfDisposed();
            _snapshot = new global::System.Collections.Generic.List<T>(_items);
        }
    }
    ...
    public bool Rollback()
    {
        lock (_lock)
        {
            ...
            _items = new global::System.Collections.Generic.List<T>(_snapshot);
            _snapshot = null;
    ...
    public void Replace(IEnumerable<T> items)
    {
        ...
        {
            ThrowIfDisposed();
            _items = new global::System.Collections.Generic.List<T>(items);
            RaiseCollectionChanged();
        }
    }
