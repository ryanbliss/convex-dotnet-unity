...
internal sealed class MutationBuilder<TResult>: IMutationBuilder<TResult>
{
...
private Func<string, string, object?, TimeSpan?, CancellationToken, Task<TResult>>? middlewareExecutor;
private SyncContextCapture? syncContext;
private Func<Func<CancellationToken, Task<TResult>>, CancellationToken, Task<TResult>>? enqueueMutation;
private ILogger? logger;
private bool enableDebugLogging;
public MutationBuilder(IHttpClientProvider httpProvider, IConvexSerializer serializer, string functionName, IReactiveCache? reactiveCache = null, Func<string, Task>? invalidateDependencies = null, Func<string, string, object?, TimeSpan?, CancellationToken, Task<TResult>>? middlewareExecutor = null, SyncContextCapture? syncContext = null, Func<Func<CancellationToken, Task<TResult>>, CancellationToken, Task<TResult>>? enqueueMutation = null, ILogger? logger = null, bool enableDebugLogging = false)
{
    ...
    this._functionName = functionName ?? throw new ArgumentNullException(nameof(functionName));
    this._reactiveCache = reactiveCache;
    this._invalidateDependencies = invalidateDependencies;
    this._middlewareExecutor = middlewareExecutor;
    this._syncContext = syncContext;
    this._logger = logger;
    this._enableDebugLogging = enableDebugLogging;
    this._enqueueMutation = enqueueMutation;
    ...
    this.enqueueMutation = enqueueMutation;
    this.logger = logger;
    ...
    private readonly Func<string, string, object?, TimeSpan?, CancellationToken, Task<TResult>>? _middlewareExecutor ;
    ...
    private readonly List<CacheUpdate> _cacheUpdates = new global::System.Collections.Generic.List<global::Convex.Client.Features.DataAccess.Mutations.MutationBuilder<TResult>.CacheUpdate>();
    private bool _skipQueue = false;
    private readonly Func<Func<CancellationToken, Task<TResult>>, CancellationToken, Task<TResult>>? _enqueueMutation ;
    ...
    public async Task<TResult> ExecuteAsync(CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            if (_reactiveCache != null && _queryFocusedOptimisticUpdate != null && _args != null)
            {
                ...
                _ = updateMethod.Invoke(_queryFocusedOptimisticUpdate, new object[] { optimisticStore, _args });
    ...
    /// </summary>
    private sealed class CacheUpdate    {
private string queryName;
private Type valueType;
private Func<object?, object?> updateFunction;
public CacheUpdate(string queryName, Type valueType, Func<object?, object?> updateFunction)
{
    ...
    this.valueType = valueType;
    this.updateFunction = updateFunction;
}        public string QueryName { get; }         public Type ValueType { get; }         public Func<object?, object?> UpdateFunction { get; }     }
...
private string queryName;
private Type valueType;
public CacheSnapshot(string queryName, Type valueType)
{
    this.QueryName = queryName;
    this.ValueType = valueType;
    this.queryName = queryName;
    this.valueType = valueType;
}        public string QueryName { get; }         public Type ValueType { get; }         public object? OriginalValue { get; set; }
