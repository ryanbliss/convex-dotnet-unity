...
public BatchMutationBuilder(IHttpClientProvider httpProvider, IConvexSerializer serializer, ILogger? logger = null, bool enableDebugLogging = false)
{
    ...
    private readonly List<(string FunctionName, object? Args, Type ResultType)> _mutations = new global::System.Collections.Generic.List<(string FunctionName, object Args, global::System.Type ResultType)>();
