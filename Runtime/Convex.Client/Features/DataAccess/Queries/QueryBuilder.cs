...
internal sealed class QueryBuilder<TResult>: IQueryBuilder<TResult>
{
...
public QueryBuilder(IHttpClientProvider httpProvider, IConvexSerializer serializer, string functionName, ILogger? logger = null, bool enableDebugLogging = false)
{
    ...
    this._functionName = functionName ?? throw new ArgumentException("Function name cannot be null.", nameof(functionName));
    this._logger = logger;
