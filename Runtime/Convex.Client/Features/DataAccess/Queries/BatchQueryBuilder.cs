...
/// </remarks>
internal sealed class BatchQueryBuilder : IBatchQueryBuilder
{
private IHttpClientProvider httpProvider;
private IConvexSerializer serializer;
private ILogger? logger;
private bool enableDebugLogging;
public BatchQueryBuilder(IHttpClientProvider httpProvider, IConvexSerializer serializer, ILogger? logger = null, bool enableDebugLogging = false)
{
    ...
    private readonly List<BatchQueryItem> _queries = new global::System.Collections.Generic.List<global::Convex.Client.Features.DataAccess.Queries.BatchQueryBuilder.BatchQueryItem>();
    ...
    public async Task<object[]> ExecuteAsync(CancellationToken cancellationToken = default)
    {
        ...
        lock (_lock)
        {
            queriesSnapshot = new global::System.Collections.Generic.List<global::Convex.Client.Features.DataAccess.Queries.BatchQueryBuilder.BatchQueryItem>(_queries);
        }
