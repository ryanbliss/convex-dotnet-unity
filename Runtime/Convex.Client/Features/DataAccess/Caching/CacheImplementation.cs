...
public CacheImplementation(ILogger? logger = null, bool enableDebugLogging = false)
{
    this._logger = logger;
...
public CacheEntry(object? value, Type valueType, DateTimeOffset timestamp)
{
    this.Value = value;
    ...
    this.valueType = valueType;
    this.timestamp = timestamp;
}        public object? Value { get; }         public Type ValueType { get; }         public DateTimeOffset Timestamp { get; }     }
}
