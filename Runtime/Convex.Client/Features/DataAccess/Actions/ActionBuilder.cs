...
internal sealed class ActionBuilder<TResult>: IActionBuilder<TResult>
{
...
public ActionBuilder(IHttpClientProvider httpProvider, IConvexSerializer serializer, string functionName, Func<string, string, object?, TimeSpan?, CancellationToken, Task<TResult>>? middlewareExecutor = null, ILogger? logger = null, bool enableDebugLogging = false)
{
