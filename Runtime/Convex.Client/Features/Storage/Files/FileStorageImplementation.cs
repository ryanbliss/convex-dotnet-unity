...
public FileStorageImplementation(IHttpClientProvider httpProvider, IConvexSerializer serializer, HttpClient uploadHttpClient, ILogger? logger = null, bool enableDebugLogging = false)
{
    ...
    this._uploadHttpClient = uploadHttpClient ?? throw new ArgumentNullException(nameof(uploadHttpClient));
    this._logger = logger;
