...
{
private FileStorageErrorType errorType;
private string message;
private string? storageId;
private Exception? innerException;
public ConvexFileStorageException(FileStorageErrorType errorType, string message, string? storageId = null, Exception? innerException = null) : base(message, innerException)
{
    ...
    /// </summary>
    public FileStorageErrorType ErrorType { get; } 
    /// <summary>
