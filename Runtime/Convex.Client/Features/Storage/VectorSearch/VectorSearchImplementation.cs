...
/// </summary>
internal sealed class VectorSearchImplementation{
private IHttpClientProvider httpProvider;
private IConvexSerializer serializer;
private ILogger? logger;
private bool enableDebugLogging;
public VectorSearchImplementation(IHttpClientProvider httpProvider, IConvexSerializer serializer, ILogger? logger = null, bool enableDebugLogging = false)
{
    ...
    private static float[]? ExtractVector(JsonElement element)
    {
        ...
        return global::System.Linq.Enumerable.ToArray(vectorElement.EnumerateArray().Select(v => v.GetSingle()));
    }
