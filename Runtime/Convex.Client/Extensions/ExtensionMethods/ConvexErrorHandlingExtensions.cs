...
public static class ConvexErrorHandlingExtensions
{
        ...
        TimeSpan? delay = null)
    {
        ...
        if (retryCondition is null) { throw new ArgumentNullException(nameof(retryCondition)); }
    ...
    {
        if (source is null) { throw new ArgumentNullException(nameof(source)); }
        if (errorReporter is null) { throw new ArgumentNullException(nameof(errorReporter)); }
