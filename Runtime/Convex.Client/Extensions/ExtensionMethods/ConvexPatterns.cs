...
public static class ConvexPatterns
{
        ...
        Func<T, T>? rollbackUpdate = null)
    {
        ...
        if (optimisticUpdate is null) { throw new ArgumentNullException(nameof(optimisticUpdate)); }
        if (serverOperation is null) { throw new ArgumentNullException(nameof(serverOperation)); }
    ...
    {
        if (client is null) { throw new ArgumentNullException(nameof(client)); }
        if (queryFunction is null) { throw new ArgumentNullException(nameof(queryFunction)); }
        if (pageSize <= 0) { throw new ArgumentOutOfRangeException(nameof(pageSize)); }
        if (loadThreshold < 0) { throw new ArgumentOutOfRangeException(nameof(loadThreshold)); }
    ...
    {
        if (client is null) { throw new ArgumentNullException(nameof(client)); }
        if (searchFunction is null) { throw new ArgumentNullException(nameof(searchFunction)); }
        if (minQueryLength < 0) { throw new ArgumentOutOfRangeException(nameof(minQueryLength)); }
    ...
    {
        if (client is null) { throw new ArgumentNullException(nameof(client)); }
        if (subscriptionFunction is null) { throw new ArgumentNullException(nameof(subscriptionFunction)); }
