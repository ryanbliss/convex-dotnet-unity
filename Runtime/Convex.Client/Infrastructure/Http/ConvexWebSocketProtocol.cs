    ...
    public static ReadOnlyMemory<byte> EncodeClientMessage(ClientMessage message)
    {
        ...
        switch (message)
        {
            ...
            case MutationMessage mutation:
                ...
                writer.WriteStartArray("args");
                foreach (var arg in mutation.Args ?? global::System.Array.Empty<object>())
                {
                    JsonSerializer.Serialize(writer, arg);
                }
                writer.WriteEndArray();
            ...
            case ActionMessage action:
                ...
                writer.WriteStartArray("args");
                foreach (var arg in action.Args ?? global::System.Array.Empty<object>())
                {
                    JsonSerializer.Serialize(writer, arg);
                }
                writer.WriteEndArray();
        ...
        try
        {
            ...
            return messageType switch
            {
                ...
                "Transition" => new TransitionMessage
                {
                    ...
                    Modifications = global::System.Linq.Enumerable.ToArray(jsonDoc.RootElement.GetProperty("modifications").EnumerateArray())
                },
...
public record ModifyQuerySetMessage : ClientMessage
{
    ...
    /// </summary>
    public QuerySetModification[] Modifications { get; init; } = global::System.Array.Empty<global::Convex.Client.Infrastructure.Http.QuerySetModification>();
}
...
public record MutationMessage : ClientMessage
{
    ...
    /// </summary>
    public object?[] Args { get; init; } = global::System.Array.Empty<object>();
...
public record TransitionMessage : ServerMessage
{
    ...
    /// Gets or sets the modifications.
    /// </summary>
    public JsonElement[] Modifications { get; init; } = global::System.Array.Empty<global::System.Text.Json.JsonElement>();
}
...
public readonly struct ConvexTimestamp : IEquatable<ConvexTimestamp>
{
public ConvexTimestamp(long value)
{
    this.Value = value;
}    /// <summary>
    /// Gets the value.
