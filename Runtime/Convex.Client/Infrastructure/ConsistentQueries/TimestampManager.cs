...
public TimestampManager(HttpClient httpClient, string deploymentUrl)
{
    this._httpClient = httpClient ?? throw new ArgumentNullException(nameof(httpClient));
    this._deploymentUrl = deploymentUrl?.TrimEnd('/') ?? throw new ArgumentNullException(nameof(deploymentUrl));
