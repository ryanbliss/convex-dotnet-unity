...
private IReadOnlyList<IConvexInterceptor> interceptors;
private ILogger? logger;
private bool enableDebugLogging;
public InterceptorPipeline(IReadOnlyList<IConvexInterceptor> interceptors, ILogger? logger = null, bool enableDebugLogging = false)
{
    this._interceptors = interceptors ?? throw new ArgumentNullException(nameof(interceptors));
    this._logger = logger;
    this._enableDebugLogging = enableDebugLogging;
    this.interceptors = interceptors;
    this.logger = logger;
    this.enableDebugLogging = enableDebugLogging;
}    private readonly IReadOnlyList<IConvexInterceptor> _interceptors ;
