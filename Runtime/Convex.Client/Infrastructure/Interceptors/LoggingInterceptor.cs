...
public sealed class LoggingInterceptor : IConvexInterceptor
{
private ILogger logger;
private LogLevel requestLogLevel;
private LogLevel responseLogLevel;
private LogLevel errorLogLevel;
public LoggingInterceptor(ILogger logger, LogLevel requestLogLevel = LogLevel.Information, LogLevel responseLogLevel = LogLevel.Information, LogLevel errorLogLevel = LogLevel.Error)
{
    this._logger = logger ?? throw new ArgumentNullException(nameof(logger));
    this._requestLogLevel = requestLogLevel;
    this._responseLogLevel = responseLogLevel;
    this._errorLogLevel = errorLogLevel;
    this.logger = logger;
