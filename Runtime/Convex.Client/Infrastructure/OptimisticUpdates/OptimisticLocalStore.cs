...
internal sealed class OptimisticLocalStore : IOptimisticLocalStore
{
    ...
    private readonly HashSet<string> _modifiedQueries = new global::System.Collections.Generic.HashSet<string>();
    private readonly Dictionary<string, object?> _originalValues = new global::System.Collections.Generic.Dictionary<string, object>();
