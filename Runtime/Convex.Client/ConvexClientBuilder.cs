...
public sealed class ConvexClientBuilder
{
    ...
    private readonly List<IConvexMiddleware> _middleware = new global::System.Collections.Generic.List<global::Convex.Client.Infrastructure.Middleware.IConvexMiddleware>();
    ...
    /// </summary>
    private sealed class InlineMiddleware : IConvexMiddleware
    {
private Func<ConvexRequest, ConvexRequestDelegate, Task<ConvexResponse>> middleware;
public InlineMiddleware(Func<ConvexRequest, ConvexRequestDelegate, Task<ConvexResponse>> middleware)
{
    this._middleware = middleware;
    this.middleware = middleware;
}        private readonly Func<ConvexRequest, ConvexRequestDelegate, Task<ConvexResponse>> _middleware ;
